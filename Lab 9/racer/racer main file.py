...
background_image = pygame.image.load("images/street.png")
...
# background sound
pygame.mixer.music.load('music/back music.wav')
...
class Coin(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("images/gold coin.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, screen_width - 40), 0)
...
class BigCoin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('images/red coin.png')
        self.rect = self.image.get_rect()
    def move(self):
        self.rect.move_ip(0, speed)
